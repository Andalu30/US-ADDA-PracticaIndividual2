...
public class ProblemaMochila {
	 ...
	 * @return N�mero entero de unidades del objeto que est� en la posici�n index que caben en un mochila de la capacidad dada
	 */
	 ...
	 * @param index Indice del problema this
	 * @param capacidad Capacidad del problema this
	 * @return N�mero real de unidades del objeto que est� en la posici�n index que caben en un mochila de la capacidad dada
	 */
	...
	/**
	 * @pre a est� contenida en getAlternativas()
	...
	/**
	 * @return Una cota superior del valor de la soluci�n del problema this
	 */
	 ...
	 * @return Una cota superior del valor de la soluci�n del problema this si se escoge la alternativa a
	 */
	...
	/**
	 * @return Una cota inferior del valor de la soluci�n del problema this
	 */
	 ...
	 * @pre a est� contenida en getAlternativas()
	 * @param a Una alternativa de this
	 * @return Una cota inferior del valor de la soluci�n del problema this si se escoge la alternativa a
	 */
	...
	/**
	 * @param s Una posible soluci�n
	 * @return s es una solcui�n de this si su peso es menor que la capacidad de la mochila y el n�mero de unidades de
	 * cada objeto menor o igual que el n�mero m�ximo de unidades permitido
	 */
